...
// migration (version 12) for the same reason the v8 repair is: it needs URL
...
//     data migration.
const repairOriginNormalizationVersion int64 = 12
...
func registerOriginNormalizationMigration() {
	registerOriginRepairOnce.Do(func() {
		...
		m.Source = "012_normalize_network_origins.go"
