...
func TestWidgetPreambleCannotWriteState(t *testing.T) {
	doc := injectPreamble("<head></head>", "abc", "https://app.test",
		map[string]string{"k": "v"}, true, false, nil)
...
func TestWidgetPreambleInstallsNoCapabilityBridges(t *testing.T) {
	doc := injectPreamble("<head></head>", "abc", "https://app.test", nil, true, false, nil)
	...
	// not a removal.
	full := injectPreamble("<head></head>", "abc", "https://app.test", nil, false, false, nil)
...
func TestWidgetPreambleAddsBaseStylesheet(t *testing.T) {
	...
	if strings.Contains(injectPreamble("<head></head>", "abc", "https://app.test", nil, false, false, nil), "background:transparent") {
...
func TestWidgetPreambleReportsHealthToHost(t *testing.T) {
	...
	// banner besides.
	if strings.Contains(injectPreamble("<head></head>", "abc", "https://app.test", nil, false, false, nil), "__avWidget") {
