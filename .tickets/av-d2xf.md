...
- internal/api/gallery.go — capabilityView (all construction sites: detail, edit, popover) gains LinksApproved, fed from the new links_approved column (child ticket).
